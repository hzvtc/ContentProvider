package com.adcp.contentProvider;
...
import com.adcp.util.ContentData;
import com.adcp.util.DBOpenHelper;
/**
...
public class TeacherContentProvider extends ContentProvider {
    ...
    private UriMatcher uriMatcher= ContentData.UserTableData.uriMatcher;

    /* 自定义匹配码 */
    public static final int TEACHERS = ContentData.UserTableData.TEACHERS;
    /* 自定义匹配码 */
    public static final int TEACHER = ContentData.UserTableData.TEACHER;

    // 数据集的MIME类型字符串则应该以vnd.android.cursor.dir/开头
    public static final String CONTENT_TYPE = ContentData.UserTableData.CONTENT_TYPE;
    // 单一数据的MIME类型字符串应该以vnd.android.cursor.item/开头
    public static final String CONTENT_TYPE_ITME = ContentData.UserTableData.CONTENT_TYPE_ITME;
    /**
